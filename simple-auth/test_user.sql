...
insert into simple_auth_user_role(user_id, role_id)
values (currval('sq_simple_auth_user'), 1);
insert into simple_auth_user_role(user_id, role_id)
values (currval('sq_simple_auth_user'), 2);

insert into simple_auth_role(id, name)
values (nextval('sq_simple_auth_role'), 'view-hotels');
insert into simple_auth_user_role(user_id, role_id)
values (currval('sq_simple_auth_user'), currval('sq_simple_auth_role'));

insert into simple_auth_role(id, name)
values (nextval('sq_simple_auth_role'), 'manage-hotels');
insert into simple_auth_user_role(user_id, role_id)
values (currval('sq_simple_auth_user'), currval('sq_simple_auth_role'));
